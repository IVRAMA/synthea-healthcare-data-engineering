...
CREATE OR REPLACE TABLE synthea_raw.util.synthea_flattened_L2 AS
select upper(table_name) as table_name, upper(column_name) as column_name, upper(col_data_type) column_data_type
from 
(select 
