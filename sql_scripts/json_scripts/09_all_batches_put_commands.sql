PUT file://D:/dbt_projects/healthcare_db/json/stream_100_pats/*.json @HEALTHCARE_JSON_RAW.STAGING.stage_synthea_STREAM_100_PATS AUTO_COMPRESS=TRUE;
...
PUT file://D:/dbt_projects/healthcare_db/json/batch_07/*.json @HEALTHCARE_JSON_RAW.STAGING.stage_synthea_batch_07 AUTO_COMPRESS=TRUE;

PUT file://D:/dbt_projects/healthcare_db/json/batch_08/*.json @HEALTHCARE_JSON_RAW.STAGING.stage_synthea_batch_08 AUTO_COMPRESS=TRUE;